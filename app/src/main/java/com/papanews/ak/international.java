...
public class international extends Fragment implements CardStackListener {
...
//        Audio player media
        ...
        drawable  = getResources().getDrawable(R.drawable.internationalbgbg);
...
//        rewind_view.bringToFront();
        ...
        rewind_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                manager = new CardStackLayoutManager(getContext(), international.this);
                adapter = new CardStackAdapter(addList(), getContext());
                cardStackView = view.findViewById(R.id.card_stack_view);
                cardStackView.setLayoutManager(manager);
                cardStackView.setAdapter(adapter);
    ...
    private List<ItemModel> addList(){
        ...
        jsonPreferences = sharedPref.getString("international", "");
...
//                            sav.setBackgroundColor(Color.parseColor("#F4931D"));
    ...
    private void addDataToDatabase(final String Views, final String imageId) {
        ...
        String url = "http://papanews.in/PapaNews/updateViews/viewsInternational.php";
