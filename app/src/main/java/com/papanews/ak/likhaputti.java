...
public class likhaputti extends AppCompatActivity {
    RelativeLayout abtus,tabdc,noin,langu;
    ConstraintLayout cons;
    CardView langub1,langub2;
    Button noir,langureferesh;
    int cs1=0,cs2=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final ConnectionDectector cd = new ConnectionDectector(likhaputti.this);
                if (!(cd.isConnected())) {
                    Toast.makeText(likhaputti.this, "No internet connection", Toast.LENGTH_SHORT).show();
                }else{
...
//                    v.getContext().startActivity(intent);
                    Intent intent = new Intent(likhaputti.this, MainActivity.class);
                    startActivity(intent);
...
//                    finish();
                    ...
                    Toast.makeText(likhaputti.this, "Please select your language", Toast.LENGTH_SHORT).show();
                }
            }
        });
