...
public class select_category extends AppCompatActivity {
    ...
    CardView technews,politicsnews,entertainnews,businessnews,international,startup,sports,infu,miscell;
    Button nex;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startup = (CardView)findViewById(R.id.b2);
        technews = findViewById(R.id.b3);
        entertainnews = findViewById(R.id.b4);
        sports = (CardView)findViewById(R.id.b5);
        politicsnews = findViewById(R.id.b6);
        international = findViewById(R.id.b7);
        infu = (CardView)findViewById(R.id.b8);
        miscell = (CardView)findViewById(R.id.b9);
...
//            catstate[i] = prefs.getInt("catpre"+i, 0);
//        }
...
//                    reco.remove("Currentaf");
        ...
        nex.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(count<1){
                    Toast.makeText(getApplicationContext(), "Please select any two categories", Toast.LENGTH_SHORT).show();
                }else{
