...
public class Business extends Fragment implements CardStackListener {
...
//        submit_report = view.findViewById(R.id.cv);
        ...
        doodle = view.findViewById(R.id.doodle);
        ...
        drawable  = getResources().getDrawable(R.drawable.businessbgbg);
        doodle.setImageDrawable(drawable);
...
//        rewind_view.bringToFront();
        ...
        rewind_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                manager = new CardStackLayoutManager(getContext(), Business.this);
                adapter = new CardStackAdapter(addList(), getContext());
                manager.setTranslationInterval(8f);
                manager.setDirections(Direction.VERTICAL);
                manager.setStackFrom(StackFrom.Top);
    ...
    private List<ItemModel> addList(){
        ...
        jsonPreferences = sharedPref.getString("business", "");
...
//                            sav.setBackgroundColor(Color.parseColor("#F4931D"));
    ...
    private void addDataToDatabase(final String Views, final String imageId) {
        ...
        String url = "http://papanews.in/PapaNews/updateViews/viewsBusiness.php";
