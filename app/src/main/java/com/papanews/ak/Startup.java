...
public class Startup extends Fragment implements CardStackListener {
    ...
    TextView textView,normal,datev;
...
//        Audio player media
        ...
        drawable  = getResources().getDrawable(R.drawable.startbgbg);
...
//        rewind_view.bringToFront();
        ...
        rewind_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                manager = new CardStackLayoutManager(getContext(), Startup.this);
                adapter = new CardStackAdapter(addList(), getContext());
                cardStackView = view.findViewById(R.id.card_stack_view);
                cardStackView.setLayoutManager(manager);
                cardStackView.setAdapter(adapter);
    ...
    private List<ItemModel> addList(){
        ...
        jsonPreferences = sharedPref.getString("startup", "");
...
//        datev= view.findViewById(R.id.datenews);
...
//                        draw = getResources().getDrawable(ic_baseline_pause_24);
            ...
            checkIfSaved(product.getString("image"),product.getString("title"),product.getString("longd")
                    ...
                    product.getString("LongText"),product.getString("audioType"),
                    product.getString("video"));
//            datev.setText(product.getString("title"));
...
//                            sav.setBackgroundColor(Color.parseColor("#F4931D"));
    ...
    private void addDataToDatabase(final String Views, final String imageId) {
        ...
        String url = "http://papanews.in/PapaNews/updateViews/viewsStartup.php";
